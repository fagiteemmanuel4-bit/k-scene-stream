    ...
    <div className="min-h-screen bg-[#FDFDFD] pb-32">
          ...
          <div className="w-full max-w-sm rounded-[40px] bg-white p-8 shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleFeatureSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-gray-400 px-2 tracking-widest">
              ...
              <button
                onClick={() => {
                  ...
                  setTimeout(() => {
                    ...
                    toast.success("Preferences updated instantly!", {
                      icon: <Zap className="h-4 w-4 text-yellow-400 fill-current" />,
                    });
                  }, 800);
                }}
                disabled={isSaving}
                className="flex w-full items-center justify-center gap-2 rounded-full bg-primary py-4 text-xs font-black uppercase tracking-widest text-white shadow-lift transition active:scale-95 disabled:opacity-50"
              >
                {isSaving ? (
      ...
      <div className="bg-white px-8 pt-10 pb-10 rounded-b-[60px] shadow-sm border-b border-gray-50">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-black italic tracking-tighter uppercase text-gray-900">
            {user.email?.split("@")[0]}
          </h2>
          <div className="mt-2.5 flex items-center gap-3">
            <span className="bg-gray-100 px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest text-gray-500">
              Elite Member
            </span>
      ...
      <div className="px-6 -mt-8 space-y-6">
        ...
        {/* App Preferences */}
        <div className="space-y-3">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 px-4">
            App Preferences
          </p>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white rounded-[40px] border border-gray-50 shadow-sm divide-y divide-gray-50">
            ...
            >
              ...
              <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-[9px] font-black uppercase">
                Feedback
              </span>
            </button>
