...
function ArticleCard({
  ...
  return (
    <div
      className={`overflow-hidden rounded-2xl bg-white shadow-card ${featured ? "ring-2 ring-primary/20" : ""}`}
    >
      {/* Media */}
      ...
      <div className="p-4">
        ...
        <h2
          className={`font-bold leading-snug text-gray-900 ${featured ? "mt-2 text-lg" : "mt-1 text-sm"}`}
        >
          {article.title}
        </h2>
        ...
        <div
          className={`mt-2 text-sm leading-relaxed text-gray-600 ${expanded ? "" : "line-clamp-3"}`}
        >
