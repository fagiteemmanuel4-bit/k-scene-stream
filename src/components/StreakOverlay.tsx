...
export function StreakOverlay() {
  ...
  const msg = streak >= 30 ? "Legendary viewer 🏆" : streak >= 14 ? "Dedicated fan 🔥" : streak >= 7 ? "K-drama addict 💜" : "Keep it up!";

  return (
    <div className="pointer-events-none fixed inset-0 z-[200] flex items-center justify-center" aria-hidden>
      <div
        style={{
